...
def _append_crash_fingerprint(stage, x, reason, details=None):
    ...
    log_path = os.environ.get('PHOTOCHEM_ERROR_LOG', 'data/grid_results/photochem_crash_fingerprints.log')
...
def find_PT_grid(filename='data/grid_results/PICASO_climate_updatop_full_exploration_reducedrad_solveSegFault.h5', rad_plan=None, log10_planet_metallicity=None, tint=None, semi_major=None, ctoO=None, gridvals=PICASO_Climate_grid.get_gridvals_PICASO_TP()):
    """
...
def Photochem_1D_model(x):
    ...
    sol, soleq, pc, convergence_values, converged_PC, status, error = Photochem_Gas_Giant(rad_plan=rad_plan_earth_units, log10_planet_metallicity=log10_planet_metallicity, tint=tint_K, semi_major=semi_major_AU, ctoO=ctoO_solar, log_Kzz=log_Kzz, PT_filename='data/grid_results/PICASO_climate_updatop_full_exploration_reducedrad_solveSegFault.h5')
