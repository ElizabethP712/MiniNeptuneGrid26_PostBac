...
def find_PT_sol(filepath='/mnt/c/Users/lily/Documents/NASAUWPostbac/MiniNeptuneGrid26_PostBac/data/grid_results/PICASO_climate_updatop_paramext_K218b.h5',rad_plan=None, log10_planet_metallicity=None, tint=None, semi_major=None, ctoO=None, grid_gridvals=PICASO_Climate_grid.get_gridvals_PICASO_TP()):
...
def find_Photochem_match(filename='data/grid_results/Photochem_1D_updatop_paramext_K218b.h5', rad_plan=None, log10_planet_metallicity=None, tint=None, semi_major=None, ctoO=None, Kzz=None, gridvals= Photochem_grid.get_gridvals_Photochem()):
...
def find_Photochem_sol(filepath='/mnt/c/Users/lily/Documents/NASAUWPostbac/MiniNeptuneGrid26_PostBac/data/grid_results/Photochem_1D_updatop_paramext_K218b.h5', rad_plan=None, log10_planet_metallicity=None, tint=None, semi_major=None, ctoO=None, Kzz=None, grid_gridvals=Photochem_grid.get_gridvals_Photochem()):
