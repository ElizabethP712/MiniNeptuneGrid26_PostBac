...
if __name__ == "__main__":
    ...
    gridutils.make_grid(
        ...
        filename='results/PICASO_climate_updatop_full_exploration_reducedrad_batchA.h5', 
        progress_filename='results/PICASO_climate_updatop_full_exploration_reducedrad_batchA.log'
    ) 
