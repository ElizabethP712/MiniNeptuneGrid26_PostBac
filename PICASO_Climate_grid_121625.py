...
def get_gridvals_PICASO_TP():
    ...
    tint_K = np.array([100, 250, 400]) # in Kelvin
...
if __name__ == "__main__":
    ...
    gridutils.make_grid(
        ...
        filename='results/PICASO_climate_updatop_paramext_refineTINT_lowdist.h5', 
        progress_filename='results/PICASO_climate_updatop_paramext_refineTINT_lowdist.log'
    ) 
