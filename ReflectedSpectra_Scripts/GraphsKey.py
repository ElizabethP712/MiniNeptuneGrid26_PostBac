...
def find_all_plotting_values(rad_plan=None, planet_metal=None, tint=None, semi_major=None, ctoO=None, kzz=None, calc_PT=True, calc_PhotCh=True, PT_filepath='/mnt/c/Users/lily/Documents/NASAUWPostbac/MiniNeptuneGrid26_PostBac/data/grid_results/PICASO_climate_updatop_full_exploration_reducedrad_solveSegFault.h5'):
...
def plot_PT(rad_plan=None, planet_metal=None, tint=None, semi_major=None, ctoO=None, kzz=None, calc_PT=True, calc_PhotCh=True, PT_filepath='/mnt/c/Users/lily/Documents/NASAUWPostbac/MiniNeptuneGrid26_PostBac/data/grid_results/PICASO_climate_updatop_full_exploration_reducedrad_solveSegFault.h5'):
