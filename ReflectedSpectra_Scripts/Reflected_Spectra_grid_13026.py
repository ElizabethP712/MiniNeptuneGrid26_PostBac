...
def reflected_spectrum_planet_Sun(rad_plan=None, planet_metal=None, tint=None, semi_major=None, ctoO=None, Kzz=None, phase_angle=None, Photochem_file='data/grid_results/Photochem_1D_fv.h5', atmosphere_kwargs={}):
...
if __name__ == "__main__":
    ...
    gridutils.make_grid(
        ...
        filename='data/grid_results/ReflectedSpectra_fv.h5', 
        progress_filename='data/grid_results/ReflectedSpectra_fv.log'
    )
